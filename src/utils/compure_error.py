...
'''
def compute_error(obs, hyp, Thr, d = euclidean_pose_distance):
    ...
    for t in range(1,T):
        ...
        for i in M[t].keys():
            ...
            if obsti_activity == hypti_activity:
                ...
                # print("i : " +str(i))
                # print("t :" + str(t))
                if int(hypti_activity) == 1:
                    f_pos += 1
                    # print("f_pos")
                if int(obsti_activity) == 1:
                    f_neg += 1
                #     print("f_neg")
                # print("####")
    ...
    print("n  :" + str(n))
    print("f_neg : " + str(float(f_neg)/n))
    print("f_pos : " + str(float(f_pos)/n))
    print("SA : " + str(SA))
